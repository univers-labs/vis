    ...
    if (this.popupObj !== undefined) {
      ...
      if (this.popupObj.id !== previousPopupObjId) {
        ...
        if (popupType === 'node') {
          ...
          let afx = this.canvas._XconvertCanvasToDOM(this.popupObj.from.x);
          let afy = this.canvas._YconvertCanvasToDOM(this.popupObj.from.y);

          afx += this.options.labelOffset.x;
          afy += this.options.labelOffset.y;

          let atx = this.canvas._XconvertCanvasToDOM(this.popupObj.to.x);
          let aty = this.canvas._YconvertCanvasToDOM(this.popupObj.to.y);

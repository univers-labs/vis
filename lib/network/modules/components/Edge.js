...
class Edge {
  ...
  drawArrows(ctx, arrowData) {
    if (this.options.arrows.from.enabled   === true) {this.edgeType.drawChevron(ctx, this.selected, this.hover, arrowData.from);}
    if (this.options.arrows.middle.enabled === true) {this.edgeType.drawChevron(ctx, this.selected, this.hover, arrowData.middle);}
    if (this.options.arrows.to.enabled     === true) {this.edgeType.drawChevron(ctx, this.selected, this.hover, arrowData.to);}
  }
